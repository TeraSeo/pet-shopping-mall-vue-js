                  ...
                  <v-col>
                    ...
                    <v-form ref="login_form" v-model="valid" lazy-validation>
                      ...
                      <v-text-field
                        ...
                        variant="solo-filled"
                      ></v-text-field>
                      <v-btn class="login-btn mt-5" @click="login" block>Log in now</v-btn>
                    </v-form>
                    <v-row class="mt-3">
                      <v-col class="text-left">
                        <span @click="goToRegister" style="cursor: pointer;" class="text-span">Create new account</span>
                      </v-col>
                      <v-col class="text-right">
                        <span style="cursor: pointer;" class="text-span">Forgot password</span>
                      </v-col>
                    </v-row>
